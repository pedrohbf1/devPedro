 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(j,N){var T=j.length;j.push(N);e:for(;0<T;){var A=T-1>>>1,B=j[A];if(0<o(B,N))j[A]=N,j[T]=B,T=A;else break e}}function n(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var N=j[0],T=j.pop();if(T!==N){j[0]=T;e:for(var A=0,B=j.length,Ht=B>>>1;A<Ht;){var Be=2*(A+1)-1,mt=j[Be],je=Be+1,nt=j[je];if(0>o(mt,T))je<B&&0>o(nt,mt)?(j[A]=nt,j[je]=T,A=je):(j[A]=mt,j[Be]=T,A=Be);else if(je<B&&0>o(nt,T))j[A]=nt,j[je]=T,A=je;else break e}}return N}function o(j,N){var T=j.sortIndex-N.sortIndex;return T!==0?T:j.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var a=[],u=[],h=1,g=null,m=3,x=!1,w=!1,S=!1,L=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(j){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=j)r(u),N.sortIndex=N.expirationTime,t(a,N);else break;N=n(u)}}function v(j){if(S=!1,p(j),!w)if(n(a)!==null)w=!0,Qn(C);else{var N=n(u);N!==null&&Ut(v,N.startTime-j)}}function C(j,N){w=!1,S&&(S=!1,f(_),_=-1),x=!0;var T=m;try{for(p(N),g=n(a);g!==null&&(!(g.expirationTime>N)||j&&!Ee());){var A=g.callback;if(typeof A=="function"){g.callback=null,m=g.priorityLevel;var B=A(g.expirationTime<=N);N=e.unstable_now(),typeof B=="function"?g.callback=B:g===n(a)&&r(a),p(N)}else r(a);g=n(a)}if(g!==null)var Ht=!0;else{var Be=n(u);Be!==null&&Ut(v,Be.startTime-N),Ht=!1}return Ht}finally{g=null,m=T,x=!1}}var E=!1,y=null,_=-1,D=5,$=-1;function Ee(){return!(e.unstable_now()-$<D)}function At(){if(y!==null){var j=e.unstable_now();$=j;var N=!0;try{N=y(!0,j)}finally{N?Bt():(E=!1,y=null)}}else E=!1}var Bt;if(typeof c=="function")Bt=function(){c(At)};else if(typeof MessageChannel<"u"){var Vr=new MessageChannel,Ni=Vr.port2;Vr.port1.onmessage=At,Bt=function(){Ni.postMessage(null)}}else Bt=function(){L(At,0)};function Qn(j){y=j,E||(E=!0,Bt())}function Ut(j,N){_=L(function(){j(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_continueExecution=function(){w||x||(w=!0,Qn(C))},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(j){switch(m){case 1:case 2:case 3:var N=3;break;default:N=m}var T=m;m=N;try{return j()}finally{m=T}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(j,N){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var T=m;m=j;try{return N()}finally{m=T}},e.unstable_scheduleCallback=function(j,N,T){var A=e.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?A+T:A):T=A,j){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=T+B,j={id:h++,callback:N,priorityLevel:j,startTime:T,expirationTime:B,sortIndex:-1},T>A?(j.sortIndex=T,t(u,j),n(a)===null&&j===n(u)&&(S?(f(_),_=-1):S=!0,Ut(v,T-A))):(j.sortIndex=B,t(a,j),w||x||(w=!0,Qn(C))),j},e.unstable_shouldYield=Ee,e.unstable_wrapCallback=function(j){var N=m;return function(){var T=m;m=N;try{return j.apply(this,arguments)}finally{m=T}}}})(tc);ec.exports=tc;var cp=ec.exports;/**
 * @license React
...
`,N0=()=>d.jsxs(O0,{id:"sobre-mim",children:[d.jsx("img",{src:"https://firebasestorage.googleapis.com/v0/b/devpedro-b54e3.appspot.com/o/FotoPerfil.jpeg?alt=media&token=256886ed-8ddf-4536-9df1-55d8e3772413",alt:""}),d.jsxs("div",{children:[d.jsxs("h2",{children:["Desenvolvedor ",d.jsx("br",{}),"Front end"]}),d.jsxs("p",{children:["Sou um Desenvolvedor Front-End apaixonado por transformar conceitos em realidade, unindo habilidades técnicas e criatividade. Estou constantemente em busca de novas oportunidades para aprimorar minhas habilidades e enfrentar desafios em projetos inovadores. Meu objetivo é a constante aprendizagem e crescimento profissional na área. Possuo expertise nas seguintes tecnologias: ",d.jsx("strong",{children:"JavaScript"}),","," ",d.jsx("strong",{children:"React.js"}),". Além disso, tenho experiência em outras tecnologias como ",d.jsx("strong",{children:"Firebase"}),", ",d.jsx("strong",{children:"Node.js"}),","," ",d.jsx("strong",{children:"MySQL"}),"."]})]}),d.jsxs("section",{children:[d.jsx("a",{href:"https://github.com/pedrohbf1",children:"Github"}),d.jsx("a",{href:"https://www.linkedin.com/in/pedro-henrique-2a861827b/",children:"Linkedin"})]}),d.jsx(M0,{})]}),T0=Wn`
  from {
